...
keywords = ["", ""]
description = "Přečtěte si, jak jsem postupoval při testování mašiny s názvem **Baby** na platformě **Vulnlab**. Dozvíte se, jak může vypadat penetrační test Windows Active Directory prostředí a jak lze využít členství ve skupině pro eskalaci práv na doménovém řadiči."
